...
const Card2: React.FC = () => {
  return (
    <div className="w-[250px] h-[150px] border border-gray-300 rounded-lg shadow-md p-4 bg-white flex flex-col justify-between">
      {/* Top Section: Image and Driving License Details */}
      <div className="flex items-center">
        ...
        {/* Text Content */}
        <div className="ml-4">
          <h3 className="text-sm font-medium text-gray-800">Driving License</h3>
          <p className="text-sm text-gray-600">KL26********123</p>
        </div>
      </div>
